...
class AuthTestes {
    ...
    fun setup() {
        ...
        @Test
        fun `quando email vazio na validacao local deve atualizar state com erro no email`() =
            runTest {
        ...
        @Test
        fun `quando senha vazia na validacao local deve atualizar state com erro na senha`() =
            runTest {
